...
interface CancelSolicitationEmailProps {
  inscricao: Player;
  torneioTitle: string;
}
...
export default function CancelSolicitationEmail({
  inscricao,
  torneioTitle,
}: CancelSolicitationEmailProps) {
  ...
  return (
    <EmailLayout
      preview={`Solicitação de cancelamento no torneio ${torneioTitle}`}
      titulo="Solicitação de cancelamento"
    >
      <Text style={paragrafo}>
        A inscrição abaixo solicitou o cancelamento. Confira os dados e realize o
